...
import { LuUsers, LuChevronRight, LuDatabase, LuBarChart3, LuKeyRound, LuSnowflake } from "react-icons/lu";
      ...
      <Box sx={{ maxWidth: 640, mx: "auto", px: 1.5 }}>
        ...
        {status === "ok" && (
          <Stack spacing={1.5}>
            ...
            <NavCard to="/report" icon={<LuSnowflake />} title="Jäävuororaportti" sub="Jäävuorojen käyttöraportti tilavarauksista (aikaväli, joukkueet)" />
          </Stack>
        )}
      </Box>
    </Box>
