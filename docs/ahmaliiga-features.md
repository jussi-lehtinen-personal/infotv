...
- **U7** (T2) **Dashboard + Oma joukkue latautuvat välillä hitaasti — skeleton/progress.** (Palaute 2026-07-25.)
  ...
  - **Jäljellä: Oma joukkue (`edit.js`)** — lataus kestää usein monta kertaa; sama kuvio (skeleton-kortit heti + peek-cache). Ei vielä tehty.
