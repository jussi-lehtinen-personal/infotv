...
// Both rooms are now Graph-backed (Microsoft 365 room-mailbox calendars) — one
// system, shared two-way with Outlook. The Reservations table is no longer read or
// written (its data was migrated + is kept as a backup; purge separately later).
const ROOMS = [
  { id: 'oheistila', name: 'Oheistila', startHour: 8, endHour: 22, backend: 'm365', mailbox: process.env.OHEISTILA_ROOM_UPN || '' },
